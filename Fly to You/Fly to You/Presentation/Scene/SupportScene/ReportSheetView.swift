...
struct ReportSheetView: View {
    ...
    @StateObject private var viewModel = ReportViewModel(userRepo: DefaultUserRepo(sessionService: ProductionServiceFactory().createUserSessionService()))
    ...
    private var reportType: some View{
        VStack(alignment: .leading, spacing: Spacing.md) {
            ...
            .buttonStyle(.plain)
            .confirmationDialog("신고 유형을 선택해주세요.\n신고를 3번 이상 받은 유저는 작성이 제한됩니다.", isPresented: $showTypeDialog, titleVisibility: .visible) {
